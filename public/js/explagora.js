$(document).ready(function(){
	...
	d3.json("../bup8?obj=getListe",function (dt) {
	...
	function chargeCarte(idCarte){
		$.getJSON( "../bup8?obj=getListeLivre&idListe="+idCarte, function( data ) {		
			...
			$.each( data.livres, function( key, val ) {
				...
				if(val.data.couverture=="http://images.amazon.com/images/P/.01.MZZZZZZZ.jpg")
					val.data.couverture="../img/logo-mini.png";
			});
			*/
			...
			svg.append("image")
				...
				.attr("id", "select")
				.attr("xlink:href", "../img/select.png");
				
			svg.append("image")
				.attr("width",(radius*3.3)+"px")
				.attr("height",(radius*3.3)+"px")
				.attr("id", "selectRot")
				.attr("xlink:href", "../img/select-rot.png");
